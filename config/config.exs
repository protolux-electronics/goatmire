...
config :goatmire, :scopes,
  user: [
    default: true,
    module: Goatmire.Accounts.Scope,
    assign_key: :current_scope,
    access_path: [:user, :id],
    schema_key: :user_id,
    schema_type: :id,
    schema_table: :users,
    test_data_fixture: Goatmire.AccountsFixtures,
...
config :goatmire, GoatmireWeb.Endpoint,
  ...
  live_view: [signing_salt: "GhoJygm0"]
...
config :goatmire, Goatmire.Mailer, adapter: Swoosh.Adapters.Local
